...
import com.gianscode.wardrobe.commands.RemoveBoots;
import com.gianscode.wardrobe.commands.RemoveChestplate;
import com.gianscode.wardrobe.commands.RemoveHelmet;
import com.gianscode.wardrobe.commands.RemoveLeggings;
...
public class Main extends JavaPlugin implements Listener {
	...
	public static Inventory selectorInventory() {
		Inventory inv = Bukkit.getServer().createInventory(null, 9 * 1, "What would you like to do?");
		
		{
			ItemStack is = new ItemStack(Material.WOOL, 1, (byte) 14);
			ItemMeta meta = is.getItemMeta();
			meta.setDisplayName(ChatColor.DARK_PURPLE + "Remove Armor");
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Remove all the armor you have on!"));
			is.setItemMeta(meta);
			inv.setItem(3, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Choose from a wide range of armor utilties"));
			is.setItemMeta(meta);
			inv.setItem(5, is);
		}
	...
	public static Inventory inventorySelector() {
		Inventory inv = Bukkit.getServer().createInventory(null, 9 * 1, "Armor Selector");

		{
			ItemStack is = new ItemStack(Material.LEATHER_HELMET);
			ItemMeta meta = is.getItemMeta();
			meta.setDisplayName(ChatColor.DARK_PURPLE + "Helmets");
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Choose a helmet from our fine selection!"));
			is.setItemMeta(meta);
			inv.setItem(1, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Choose a chestplate from our fine selection!"));
			is.setItemMeta(meta);
			inv.setItem(3, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Choose a pair of leggings from our fine selection!"));
			is.setItemMeta(meta);
			inv.setItem(5, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Choose a set of boots from our fine selection!"));
			is.setItemMeta(meta);
			inv.setItem(7, is);
		}
	...
	public static Inventory helmetInventory() {
		Inventory inv = Bukkit.getServer().createInventory(null, 9 * 1, "Helmet Selector");

		{
			ItemStack is = new ItemStack(Material.LEATHER_HELMET);
			ItemMeta meta = is.getItemMeta();
			meta.setDisplayName(ChatColor.DARK_PURPLE + "Leather Helmet");
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a leather helmet"));
			is.setItemMeta(meta);
			inv.setItem(0, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a gold helmet"));
			is.setItemMeta(meta);
			inv.setItem(2, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a iron helmet"));
			is.setItemMeta(meta);
			inv.setItem(4, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a diamond helmet"));
			is.setItemMeta(meta);
			inv.setItem(6, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a chainmail helmet"));
			is.setItemMeta(meta);
			inv.setItem(8, is);
		}
	...
	public static Inventory chestplateInventory() {
		Inventory inv = Bukkit.getServer().createInventory(null, 9 * 1, "Chestplate Selector");

		{
			ItemStack is = new ItemStack(Material.LEATHER_CHESTPLATE);
			ItemMeta meta = is.getItemMeta();
			meta.setDisplayName(ChatColor.DARK_PURPLE + "Leather Chestplate");
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a leather chestplate"));
			is.setItemMeta(meta);
			inv.setItem(0, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a gold chestplate"));
			is.setItemMeta(meta);
			inv.setItem(2, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a iron chestplate"));
			is.setItemMeta(meta);
			inv.setItem(4, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a diamond chestplate"));
			is.setItemMeta(meta);
			inv.setItem(6, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a chainmail chestplate"));
			is.setItemMeta(meta);
			inv.setItem(8, is);
		}
	...
	public static Inventory leggingsInventory() {
		Inventory inv = Bukkit.getServer().createInventory(null, 9 * 1, "Legging Selector");

		{
			ItemStack is = new ItemStack(Material.LEATHER_LEGGINGS);
			ItemMeta meta = is.getItemMeta();
			meta.setDisplayName(ChatColor.DARK_PURPLE + "Leather Leggings");
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a pair of leather leggings"));
			is.setItemMeta(meta);
			inv.setItem(0, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a pair of gold leggings"));
			is.setItemMeta(meta);
			inv.setItem(2, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a pair of iron leggings"));
			is.setItemMeta(meta);
			inv.setItem(4, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a pair of diamond leggings"));
			is.setItemMeta(meta);
			inv.setItem(6, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a pair of chainmail leggings"));
			is.setItemMeta(meta);
			inv.setItem(8, is);
		}
	...
	public static Inventory bootsInventory() {
		Inventory inv = Bukkit.getServer().createInventory(null, 9 * 1, "Boot Selector");

		{
			ItemStack is = new ItemStack(Material.LEATHER_BOOTS);
			ItemMeta meta = is.getItemMeta();
			meta.setDisplayName(ChatColor.DARK_PURPLE + "Leather Boots");
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a pair of leather boots"));
			is.setItemMeta(meta);
			inv.setItem(0, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a pair of gold boots"));
			is.setItemMeta(meta);
			inv.setItem(2, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a pair of iron boots"));
			is.setItemMeta(meta);
			inv.setItem(4, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a pair of diamond boots"));
			is.setItemMeta(meta);
			inv.setItem(6, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a pair of chainmail boots"));
			is.setItemMeta(meta);
			inv.setItem(8, is);
		}
	...
	public static Inventory helmetSelectorInventory() {
		Inventory inv = Bukkit.getServer().createInventory(null, 9 * 1, "Choose your type of helmet");

		{
			ItemStack is = new ItemStack(Material.GRASS);
			ItemMeta meta = is.getItemMeta();
			meta.setDisplayName(ChatColor.DARK_PURPLE + "Hats");
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear solid blocks on your head!"));
			is.setItemMeta(meta);
			inv.setItem(3, is);
		}

		{
			...
			ItemMeta meta = is.getItemMeta();
			meta.setDisplayName(ChatColor.DARK_PURPLE + "Helmets");
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear different types of helmets on your head!"));
			is.setItemMeta(meta);
			inv.setItem(5, is);
		}
	...
	public static Inventory hatsInventory() {
...

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a grass block on your head!"));
			is.setItemMeta(meta);
			inv.setItem(0, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a piece of wood on your head!"));
			is.setItemMeta(meta);
			inv.setItem(1, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a diamond block on your head!"));
			is.setItemMeta(meta);
			inv.setItem(2, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a redstone block on your head!"));
			is.setItemMeta(meta);
			inv.setItem(3, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some TNT on your head!"));
			is.setItemMeta(meta);
			inv.setItem(4, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a slime block on your head!"));
			is.setItemMeta(meta);
			inv.setItem(5, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a bookshelf on your head!"));
			is.setItemMeta(meta);
			inv.setItem(6, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a brick on your head!"));
			is.setItemMeta(meta);
			inv.setItem(7, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear an emerald block on your head!"));
			is.setItemMeta(meta);
			inv.setItem(8, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a jukebox on your head!"));
			is.setItemMeta(meta);
			inv.setItem(9, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a Jack 'o Lantern on your head!"));
			is.setItemMeta(meta);
			inv.setItem(10, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a pumpkin on your head!"));
			is.setItemMeta(meta);
			inv.setItem(11, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a beacon on your head!"));
			is.setItemMeta(meta);
			inv.setItem(12, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a block of stone on your head!"));
			is.setItemMeta(meta);
			inv.setItem(13, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some beadrock on your head!"));
			is.setItemMeta(meta);
			inv.setItem(14, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some glass on your head!"));
			is.setItemMeta(meta);
			inv.setItem(15, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some sand on your head!"));
			is.setItemMeta(meta);
			inv.setItem(16, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some sandstone on your head!"));
			is.setItemMeta(meta);
			inv.setItem(17, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a wooden plank on your head!"));
			is.setItemMeta(meta);
			inv.setItem(18, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some iron ore on your head!"));
			is.setItemMeta(meta);
			inv.setItem(19, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some gold ore on your head!"));
			is.setItemMeta(meta);
			inv.setItem(20, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some diamond ore on your head!"));
			is.setItemMeta(meta);
			inv.setItem(21, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some emerald ore on your head!"));
			is.setItemMeta(meta);
			inv.setItem(22, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some redstone ore on your head!"));
			is.setItemMeta(meta);
			inv.setItem(23, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some coal ore on your head!"));
			is.setItemMeta(meta);
			inv.setItem(24, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some white wool on your head!"));
			is.setItemMeta(meta);
			inv.setItem(25, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a gold block on your head!"));
			is.setItemMeta(meta);
			inv.setItem(26, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some gravel on your head!"));
			is.setItemMeta(meta);
			inv.setItem(27, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a workbench on your head!"));
			is.setItemMeta(meta);
			inv.setItem(28, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a sponge on your head!"));
			is.setItemMeta(meta);
			inv.setItem(29, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a sticky piston on your head!"));
			is.setItemMeta(meta);
			inv.setItem(30, is);
		}

		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a block of lapis on your head!"));
			is.setItemMeta(meta);
			inv.setItem(31, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a dispenser on your head!"));
			is.setItemMeta(meta);
			inv.setItem(32, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some dirt on your head!"));
			is.setItemMeta(meta);
			inv.setItem(33, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some leaves on your head!"));
			is.setItemMeta(meta);
			inv.setItem(34, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some mossy cobblestone on your head!"));
			is.setItemMeta(meta);
			inv.setItem(35, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some obsidian on your head!"));
			is.setItemMeta(meta);
			inv.setItem(36, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a crafting table on your head!"));
			is.setItemMeta(meta);
			inv.setItem(37, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some ice on your head!"));
			is.setItemMeta(meta);
			inv.setItem(38, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a cactus on your head!"));
			is.setItemMeta(meta);
			inv.setItem(39, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some netherrack on your head!"));
			is.setItemMeta(meta);
			inv.setItem(40, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some soul sand on your head!"));
			is.setItemMeta(meta);
			inv.setItem(41, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a piece of glowstone on your head!"));
			is.setItemMeta(meta);
			inv.setItem(42, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a few melons on your head!"));
			is.setItemMeta(meta);
			inv.setItem(43, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a redstone lamp on your head!"));
			is.setItemMeta(meta);
			inv.setItem(44, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some end stone on your head!"));
			is.setItemMeta(meta);
			inv.setItem(45, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some hay on your head!"));
			is.setItemMeta(meta);
			inv.setItem(46, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some prismarine on your head!"));
			is.setItemMeta(meta);
			inv.setItem(47, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a coal block on your head!"));
			is.setItemMeta(meta);
			inv.setItem(48, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a piece of hardened clay on your head!"));
			is.setItemMeta(meta);
			inv.setItem(49, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear some red sandstone ore on your head!"));
			is.setItemMeta(meta);
			inv.setItem(50, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a dropper on your head!"));
			is.setItemMeta(meta);
			inv.setItem(51, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a chest on your head!"));
			is.setItemMeta(meta);
			inv.setItem(52, is);
		}
		
		{
			...
			meta.setLore(Arrays.asList(ChatColor.WHITE + "Wear a note block on your head!"));
			is.setItemMeta(meta);
			inv.setItem(53, is);
		}
